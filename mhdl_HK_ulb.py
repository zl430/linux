...
#zuolei
PublicKey = '6R68Nmf0tjKp6+qDSZws/oskfwTxkgCCLyW9//xwNyysBTN87/CyQA=='
PrivateKey = '1f8220a640389b51abd7a437e508397c9d33eb4e'
Servergroup = ["05"]
zone="HK"
...
for groupid in Servergroup:
  ...
  ulbname = "MHDL_ULB_" + groupid + "_" + zone
...
ulbinfo = a.get_DescribeULB(data_center,ulbid)
for groupid in Servergroup:
  uhostname = "MHDL_HK_" + groupid + "_" + zone_name
  ulbname = "MHDL_ULB_" + groupid + "_" + zone
...
for groupid in Servergroup:
  ulbname = "MHDL_HK_" + groupid + "_" + zone
  for ulblist in ulbinfo['DataSet']:
    if ulbname in  ulblist['Name']:
